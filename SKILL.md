...
# grpc — Skill: Package Development

> Workflow for grpc (packages/ts/grpc). Execute this workflow before, during, and
...
- This package is published (`@omnixys/grpc-ts`); consumers pin versions and rely on SemVer.
